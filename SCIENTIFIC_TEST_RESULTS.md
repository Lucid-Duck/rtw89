...
**Test Server:** Windows 11 PC (192.168.99.250) running iperf3
**Test Interface:** wlp0s20f0u6 (D-Link, IP: 192.168.99.110)
...
- All routing verified before each test: `ip route get 192.168.99.250 from 192.168.99.110` confirmed `dev wlp0s20f0u6`
